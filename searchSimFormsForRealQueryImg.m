function [ ] = searchSimFormsForRealQueryImg()
...
%     img2Orig = imread(['../formExmpImgs/Game' gameIdStr '/' gameIdStr '0' expPlayIdStr '.jpg']);
    img2 = imread(['../formImgs/Game' gameIdStr '/' gameIdStr '0' expPlayIdStr 'Rect.jpg']);
    img2Orig = imread(['../formImgs/Game' gameIdStr '/' gameIdStr '0' expPlayIdStr '.jpg']);
    searchResNum = 4;
