function [ ] = searchSimFormsForRealQueryFg()
...
for i = 1 : expPlaysSz
    ...
    q = dlmread(['../playersFgNew/Game' gameIdStr '/' 'vid' expPlayIdStr '.pos']);
    
    for j = 1 : matchPlaysSz
            curPlayId = playsIdToMatch(j);
            curPlayIdStr = sprintf ('%03d', curPlayId);
            p = dlmread(['../playersFgNew/Game' gameIdStr '/' 'vid' curPlayIdStr '.pos']);
            pCells{j} = p;
    ...
    img2 = imread(['../fgNewGrids/Game' gameIdStr '/' gameIdStr '0' expPlayIdStr 'Rect.jpg']);
    img2Orig = imread(['../fgNewGrids/Game' gameIdStr '/' gameIdStr '0' expPlayIdStr '.jpg']);
    searchResNum = 4;
    ...
    for k = 1:searchResNum
        ...
        curPlayIdStr = sprintf ('%03d', curPlayId);
        img1 = imread(['../fgNewGrids/Game' gameIdStr '/' gameIdStr '0' curPlayIdStr 'Rect.jpg']);
        img1Orig = imread(['../fgNewGrids/Game' gameIdStr '/' gameIdStr '0' curPlayIdStr '.jpg']);
        bestImg1{k} = img1;
